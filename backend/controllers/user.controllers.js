...
exports.banUser =(req,res)=>{
  ...
  // let {id} =req.body;
  // console.log("id banUser",{id})
  // console.log("id banUser",req.body.id)
    User
     .findOneAndRemove({_id:req.params})
     .then((bannedUser)=>res.status(200).json({bannedUser,msg:"User has been deleted successfully!"}))
